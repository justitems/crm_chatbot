<?php
/**
 * CRM Chatbot Vip Style
 *
 * This file contains the Vip_style class
 *
 * @author Scrisoft
 * @package CRM
...
/*
 * Vip_style class manages the Vip style
 * 
 * @author Scrisoft
 * @package CRM
 * @author   Scrisoft <asksyn@gmail.com>
 ...
 * @since 0.0.8.5
 */
class Vip_style implements CmsBaseUserAppsCollectionCrm_chatbotInterfaces\Styles {
    ...
    public function the_style_info($website_id=0) {
        ...
        // Set button shadow
        $button_shadow = the_crm_chatbot_websites_meta($website_id, 'remove_shadow_button')?'box-shadow: none !important;':'box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.28) !important;';

        // Set button background color
        $vip_background_color = the_crm_chatbot_websites_meta($website_id, 'background_color_button')?the_crm_chatbot_websites_meta($website_id, 'background_color_button'):'rgb(58, 81, 153)';
        ...
        // Vip button's icon
        $vip_button_icon = the_crm_chatbot_websites_meta($website_id, 'icon_button')?'<img src="' . the_crm_chatbot_websites_meta($website_id, 'icon_button') . '" alt="Chat Button" class="crm-chatbot-chat-default-icon">':'<img src="' . base_url('assets/base/user/apps/collection/crm-chatbot/img/vip-icon.png') . '" alt="Chat Button" class="crm-chatbot-chat-default-icon">';
        ...
        return array(
            'style_slug' => 'vip_style',
            'style_name' => $this->CI->lang->line('crm_chatbot_vip'),
            'style_button_icon' => base_url('assets/base/user/apps/collection/crm-chatbot/img/vip-icon.png'),
            'style_button_color' => $vip_background_color,
            'style_css' => array(
                'url' => base_url('assets/base/user/apps/collection/crm-chatbot/styles/css/chat-style-vip.css?ver=' . CMS_BASE_USER_APPS_CRM_CHATBOT_VERSION),
                'code' => '<style>'
                    ...
                    . '.crm-chatbot-chat-style-footer .crm-chatbot-chat-style-open-chat-btn {'
                        ...
                        . 'border-radius: 50% !important;'
                        . 'text-align: center !important;'                            
                        . 'background-color: ' . $vip_background_color . ' !important;'
                        . $button_shadow
                        . 'transition: .3s all linear !important;'
                    . '}'
                    . '.crm-chatbot-chat-style-footer .crm-chatbot-chat-style-open-chat-btn .crm-chatbot-chat-hide-icon {'
                        . 'display: none;'
                    . '}'                  
                    . '.crm-chatbot-chat-style-footer .crm-chatbot-chat-style-open-chat-btn:hover, .crm-chatbot-chat-style-open-chat-btn:focus, .crm-chatbot-chat-style-open-chat-btn:active {'
                        . 'outline: 0 !important;'
                    . '}'
                    . '.crm-chatbot-chat-style.crm-chatbot-chat-open .crm-chatbot-chat-style-footer .crm-chatbot-chat-style-open-chat-btn .crm-chatbot-chat-default-icon {'
                        . 'display: none;'
                    . '}'
                    . '.crm-chatbot-chat-style.crm-chatbot-chat-open .crm-chatbot-chat-style-footer .crm-chatbot-chat-style-open-chat-btn {'
                        . 'transform: rotateY(180deg);'
                    . '}'
                    . '.crm-chatbot-chat-style.crm-chatbot-chat-open .crm-chatbot-chat-style-footer .crm-chatbot-chat-style-open-chat-btn .crm-chatbot-chat-hide-icon {'
                        . 'display: block;'
                        . 'transform: rotateY(180deg);'
                    . '}'
            ...
            'style_html' => '<div class="crm-chatbot-chat-style' . $chat_open . '">'
                ...
                . '<div class="crm-chatbot-chat-style-footer">'
                    . '<button class="crm-chatbot-chat-style-open-chat-btn">'
                        . '<img src="' . base_url('assets/base/user/apps/collection/crm-chatbot/img/vip-icon-cancel.png') . '" alt="Hide Chat Button" class="crm-chatbot-chat-hide-icon">'
                        . $vip_button_icon
                    . '</button>'
                . '</div>'                     
            . '</div>',
