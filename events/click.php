<?php
/**
 * CRM Chatbot Click Event
 *
 * This file contains the Click event
 *
 * @author Scrisoft
 * @package CRM
...
/*
 * Click class manages the Click event
 * 
 * @author Scrisoft
 * @package CRM
 * @author   Scrisoft <asksyn@gmail.com>
 ...
 * @since 0.0.8.5
 */
class Click implements CmsBaseUserAppsCollectionCrm_chatbotInterfaces\Events {
    ...
    public function the_fields($params = array()) {
        ...
        // Set click_element_path
        $click_element_path = !empty($params['trigger'])?the_crm_chatbot_websites_triggers_meta($params['trigger'], 'click_element_path', 'text_input'):FALSE;

        // Append condition
        $condition['fields'][] = array(
            'type' => 'text',
            'slug' => 'click_element_path',
            'words' => array (
            ...
            'params' => array(
                'value' => $click_element_path?$click_element_path:'',
                'required' => TRUE
            )            
        );
        ...
        return array(
            ...
            'condition' => array(
                ...
                'instructions' => array(
                    'text' => $this->CI->lang->line('crm_chatbot_click_condition_instructions')
                )
            ...
            'actions' => array(
                ...
                'instructions' => array(
                    'text' => $this->CI->lang->line('crm_chatbot_click_actions_instructions')
                )
    ...
    public function save_data($params) {
        ...
        foreach ( $params['trigger_fields']['condition'] AS $condition_field ) {
            ...
            // Verify if field is click_element_path
            if ( $condition_field['field'] === 'click_element_path' ) {
        ...
        foreach ( $params['trigger_fields']['condition'] AS $condition_field ) {         
            ...
            if ( $condition_field['field'] === 'click_element_path' ) {
                ...
                if ( !update_crm_chatbot_websites_triggers_meta($params['trigger'], 'click_element_path', 'text_input', trim($condition_field['value'])) && (the_crm_chatbot_websites_triggers_meta($params['trigger'], 'click_element_path', 'text_input') !== trim($condition_field['value'])) ) {
    ...
    public function the_data($params) {
        ...
        if ( !$click_element_path ) {
            return false;
        }

        // Append condition
        $condition['fields'][] = array(
            'value' => $click_element_path,
            'action' => 'click'
        );
    ...
    public function the_event_info() {
        ...
        return array(
            'event_name' => $this->CI->lang->line('crm_chatbot_element_click'),
            'event_slug' => 'crm_chatbot_element_click'
        );
