<section class="crm-chatbot-page" data-quick-guide="crmchatbot">
    <div class="row theme-row-equal">
        ...
        <?php md_get_the_file(CMS_BASE_USER_APPS_CRM_CHATBOT . 'views/parts/websites.php'); ?>
    </div>
</section>
...
<script language="javascript">
    ...
    let words = {
        ...
        icon_insert_link: '<?php echo md_the_user_icon(array('icon' => 'insert_link', 'class' => 'ml-0 theme-color-black')); ?>',
