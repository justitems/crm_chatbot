<section class="crm-chatbot-page" data-quick-guide="crmchatbot">
    <div class="row theme-row-equal">
        ...
        <?php md_get_the_file(CMS_BASE_USER_APPS_CRM_CHATBOT . 'views/parts/guests.php'); ?>
    </div>
</section>
...
<script language="javascript">
    ...
    let words = {
        ...
        icon_user_2_line: '<?php echo md_the_user_icon(array('icon' => 'user_2_line', 'class' => 'theme-color-black')); ?>',
    };
