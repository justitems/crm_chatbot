<section class="crm-chatbot-page" data-quick-guide="crmchatbot" data-guest="<?php echo $this->input->get('guest', TRUE); ?>">
    <div class="row theme-row-equal">
        <?php md_get_the_file(CMS_BASE_USER_APPS_CRM_CHATBOT . 'views/parts/sidebar.php'); ?>
        <?php md_get_the_file(CMS_BASE_USER_APPS_CRM_CHATBOT . 'views/parts/guest.php'); ?>
        <?php md_get_the_file(CMS_BASE_USER_APPS_CRM_CHATBOT . 'views/parts/guest_info.php'); ?>
    </div>
</section>
