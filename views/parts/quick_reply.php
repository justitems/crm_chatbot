                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item crm-chatbot-reply-actions" aria-current="page">
                            ...
                            <span class="crm-chatbot-reply-status-active">
                            ...
                            <div class="card theme-card-box-1 theme-box-1">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <textarea placeholder="<?php echo $this->lang->line('crm_chatbot_enter_keywords_divided_by_white_spaces'); ?>" class="w-100 crm-chatbot-quick-reply-keywords"><?php echo $reply['keywords']; ?></textarea>
                                        </div>
                                    </div>                                                   
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div id="crm-chatbot-quick-reply-accuracy-dropdown" class="dropdown theme-box-2 theme-dropdown-5 theme-dropdown-icon-1">
                                                <button class="btn btn-link" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" data-accuracy="<?php echo !empty($reply['accuracy'])?$reply['accuracy']:0; ?>">
                                                    <?php echo !empty($reply['accuracy'])?$reply['accuracy']:0; ?> %
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div id="crm-chatbot-quick-reply-response-type-dropdown" class="dropdown theme-box-2 theme-dropdown-5 theme-dropdown-icon-1">
                                                <button class="btn btn-link" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" data-type="<?php echo !empty($reply['response_type'])?1:0; ?>">
                                                    <?php echo empty($reply['response_type'])?$this->lang->line('crm_chatbot_text_response'):$this->lang->line('crm_chatbot_bot_response'); ?>
                                                    <?php echo md_the_user_icon(array('icon' => 'arrow_down', 'class' => 'theme-dropdown-arrow-icon')); ?>
                                                </button>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane<?php echo !empty($reply['response_type'])?'':' active'; ?>" id="crm-chatbot-quick-reply-response-text" aria-labelledby="crm-chatbot-quick-reply-response-text-tab">
                                                    <div class="theme-modal-input-area mt-3 mb-0 p-0">
                                                        <div class="form-group crm-chatbot-text-editor-element-preview m-0">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <div class="card theme-minimal-text-editor-box">
                                                                        <div class="card-header">
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div class="theme-minimal-text-editor" contenteditable="true"><?php echo $reply['response_text']; ?></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div role="tabpanel" class="tab-pane<?php echo !empty($reply['response_type'])?' active':''; ?>" id="crm-chatbot-quick-reply-response-bot" aria-labelledby="crm-chatbot-quick-reply-response-bot-tab">
                                                    <div id="crm-chatbot-quick-reply-response-bots-dropdown" class="dropdown theme-box-2 theme-dropdown-5 theme-dropdown-icon-1">
                                                        <button class="btn btn-link d-flex justify-content-between align-items-center" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" data-bot="<?php echo $reply['response_bot']; ?>">
                                                            <div class="media">
