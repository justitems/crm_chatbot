<!-- Modal -->
<div class="modal fade theme-modal" id="crm-chatbot-website-categories-modal" tabindex="-1" role="dialog" aria-labelledby="crm-chatbot-website-categories-modal-title" aria-hidden="true">
            ...
            <?php echo form_open('user/app/crm_chatbot', array('class' => 'crm-chatbot-new-category')) ?>
                ...
                <div class="modal-body">
                    <div class="theme-modal-quick-list">
                                ...
                                <div class="theme-modal-input-area">
                                    <div class="row">
                                        ...
                                        <div class="col-5 col-xs-3">
                                            <button
                                                type="button"
                                                class="btn btn-secondary w-100 theme-background-new crm-chatbot-new-category-btn"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <ul class="list-group theme-modal-quick-list-items"></ul>
                            </div>
                        </div>  
                    </div>
                </div>
                <div class="modal-footer">
                    <div class="row m-0">
                        <div class="col-12">
                            <div class="theme-modal-input-area pt-2 pr-3 pb-2 pl-3">
                                <div class="row">
                                    <div class="col-12 text-right">
                                        <nav aria-label="categories">
                                            <ul class="theme-pagination" data-type="categories">
                                            </ul>
                                        </nav>
                                    </div>
                                </div>
