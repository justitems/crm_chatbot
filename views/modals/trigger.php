<!-- Modal -->
<div class="modal fade theme-modal" id="crm-chatbot-website-trigger-modal" tabindex="-1" role="dialog" aria-labelledby="crm-chatbot-website-trigger-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <?php echo form_open('user/app/crm_chatbot', array('class' => 'crm-chatbots-update-trigger-form')) ?>
                <div class="modal-header">
                    <h5 class="modal-title theme-font-2">
                        <?php echo md_the_user_icon(array('icon' => 'highlight')); ?>  
                        <?php echo $this->lang->line('crm_chatbot_edit_trigger'); ?>
                    </h5>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="theme-modal-input-area">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="dropdown theme-dropdown-3 theme-dropdown-icon-1" id="crm-chatbot-dropdown-triggers-events-dropdown">
