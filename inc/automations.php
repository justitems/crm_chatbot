...
// Verify if the Automations app is enabled
if ( md_the_option('app_crm_automations_enabled') && md_the_plan_feature('app_crm_automations_enabled') && md_the_team_role_permission('crm_automations') ) {
